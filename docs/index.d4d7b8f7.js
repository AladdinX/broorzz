 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut extends bt{constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}static getInstance(){return new Ut}getInitialEvent(e){return i("visible"===e,"Unknown event type: "+e),[this.visible_]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class En{constructor(e){this.index_=e}updateChild(e,t,n,s,r,o){i(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(n.getChild(s))&&a.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(bn(t,a)):i(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(wn(t,n)):o.trackChildChange(In(t,n,a))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(on,((e,i)=>{t.hasChild(e)||n.trackChildChange(bn(e,i))})),t.isLeafNode()||t.forEachChild(on,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(In(t,i,s))}else n.trackChildChange(wn(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?_n.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xn extends wt{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=je("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(i(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=xn.getListenId_(e,n),o={};this.listens_[r]=o;const a=kn(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),I(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=xn.getListenId_(e,t);delete this.listens_[n]}get(e){const t=kn(e._queryParams),n=e._path.toString(),i=new d;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+function(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=v(o.responseText)}catch(e){Ve("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Ve("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Mn(i,new Et(t.toString()+"/"+e),n)}))}class On{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Je(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Fn,qn;function Wn(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(qn=Fn||(Fn={}))[qn.OVERWRITE=0]="OVERWRITE",qn[qn.MERGE=1]="MERGE",qn[qn.ACK_USER_WRITE=2]="ACK_USER_WRITE",qn[qn.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Un{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Fn.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(At(this.path)){if(null!=this.affectedTree.value)return i(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Et(e));return new Un(Tt(),t,this.revert)}}return i(St(this.path)===e,"operationForChild called for unrelated child."),new Un(kt(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Hn{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Fn.OVERWRITE}operationForChild(e){return At(this.path)?new Hn(this.source,Tt(),this.snap.getImmediateChild(e)):new Hn(this.source,kt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Fn.MERGE}operationForChild(e){if(At(this.path)){const t=this.children.subtree(new Et(e));return t.isEmpty()?null:t.value?new Hn(this.source,Tt(),t.value):new jn(this.source,Tt(),t)}return i(St(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new jn(this.source,kt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,t,n){this.node_=e,this.fullyInitialized_=t,this.filtered_=n}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(At(e))return this.isFullyInitialized()&&!this.filtered_;const t=St(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Vn(e,t,n,i,r,o){const a=i.filter((e=>e.type===n));a.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw s("Should only compare child_ events.");const i=new jt(t.childName,t.snapshotNode),r=new jt(n.childName,n.snapshotNode);return e.index_.compare(i,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),a.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);r.forEach((s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))}))}))}function $n(e,t){return{eventCache:e,serverCache:t}}function Yn(e,t,n,i){return $n(new Bn(t,n,i),e.serverCache)}function Gn(e,t,n,i){return $n(e.eventCache,new Bn(t,n,i))}function Kn(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Qn(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xn;class Jn{constructor(e,t=(()=>(Xn||(Xn=new Kt(Ge)),Xn))()){this.value=e,this.children=t}static fromObject(e){let t=new Jn(null);return Je(e,((e,n)=>{t=t.set(new Et(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Tt(),value:this.value};if(At(e))return null;{const n=St(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(kt(e),t);if(null!=s){return{path:Dt(new Et(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(At(e))return this;{const t=St(e),n=this.children.get(t);return null!==n?n.subtree(kt(e)):new Jn(null)}}set(e,t){if(At(e))return new Jn(t,this.children);{const n=St(e),i=(this.children.get(n)||new Jn(null)).set(kt(e),t),s=this.children.insert(n,i);return new Jn(this.value,s)}}remove(e){if(At(e))return this.children.isEmpty()?new Jn(null):new Jn(null,this.children);{const t=St(e),n=this.children.get(t);if(n){const i=n.remove(kt(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new Jn(null):new Jn(this.value,s)}return this}}get(e){if(At(e))return this.value;{const t=St(e),n=this.children.get(t);return n?n.get(kt(e)):null}}setTree(e,t){if(At(e))return t;{const n=St(e),i=(this.children.get(n)||new Jn(null)).setTree(kt(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new Jn(this.value,s)}}fold(e){return this.fold_(Tt(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Dt(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Tt(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(At(e))return null;{const i=St(e),s=this.children.get(i);return s?s.findOnPath_(kt(e),Dt(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Tt(),t)}foreachOnPath_(e,t,n){if(At(e))return this;{this.value&&n(t,this.value);const i=St(e),s=this.children.get(i);return s?s.foreachOnPath_(kt(e),Dt(t,i),n):new Jn(null)}}foreach(e){this.foreach_(Tt(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Dt(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zn{constructor(e){this.writeTree_=e}static empty(){return new Zn(new Jn(null))}}function ei(e,t,n){if(At(t))return new Zn(new Jn(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const s=i.path;let r=i.value;const o=Mt(s,t);return r=r.updateChild(o,n),new Zn(e.writeTree_.set(s,r))}{const i=new Jn(n),s=e.writeTree_.setTree(t,i);return new Zn(s)}}}function ti(e,t,n){let i=e;return Je(n,((e,n)=>{i=ei(i,Dt(t,e),n)})),i}function ni(e,t){if(At(t))return Zn.empty();{const n=e.writeTree_.setTree(t,new Jn(null));return new Zn(n)}}function ii(e,t){return null!=si(e,t)}function si(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Mt(n.path,t)):null}function ri(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(on,((e,n)=>{t.push(new jt(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new jt(e,n.value))})),t}function oi(e,t){if(At(t))return e;{const n=si(e,t);return new Zn(null!=n?new Jn(n):e.writeTree_.subtree(t))}}function ai(e){return e.writeTree_.isEmpty()}function hi(e,t){return li(Tt(),e.writeTree_,t)}function li(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let s=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?(i(null!==r.value,"Priority writes must always be leaf nodes"),s=r.value):n=li(Dt(e,t),r,n)})),n.getChild(e).isEmpty()||null===s||(n=n.updateChild(Dt(e,".priority"),s)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ci(e,t){return Ii(t,e)}function ui(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));i(n>=0,"removeWrite called with nonexistent writeId.");const s=e.allWrites[n];e.allWrites.splice(n,1);let r=s.visible,o=!1,a=e.allWrites.length-1;for(;r&&a>=0;){const t=e.allWrites[a];t.visible&&(a>=n&&di(t,s.path)?r=!1:Lt(s.path,t.path)&&(o=!0)),a--}if(r){if(o)return function(e){e.visibleWrites=_i(e.allWrites,pi,Tt()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(s.snap)e.visibleWrites=ni(e.visibleWrites,s.path);else{Je(s.children,(t=>{e.visibleWrites=ni(e.visibleWrites,Dt(s.path,t))}))}return!0}return!1}function di(e,t){if(e.snap)return Lt(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Lt(Dt(e.path,n),t))return!0;return!1}function pi(e){return e.visible}function _i(e,t,n){let i=Zn.empty();for(let r=0;r<e.length;++r){const o=e[r];if(t(o)){const e=o.path;let t;if(o.snap)Lt(n,e)?(t=Mt(n,e),i=ei(i,t,o.snap)):Lt(e,n)&&(t=Mt(e,n),i=ei(i,Tt(),o.snap.getChild(t)));else{if(!o.children)throw s("WriteRecord should have .snap or .children");if(Lt(n,e))t=Mt(n,e),i=ti(i,t,o.children);else if(Lt(e,n))if(t=Mt(e,n),At(t))i=ti(i,Tt(),o.children);else{const e=I(o.children,St(t));if(e){const n=e.getChild(kt(t));i=ei(i,Tt(),n)}}}}}return i}function fi(e,t,n,i,s){if(i||s){const r=oi(e.visibleWrites,t);if(!s&&ai(r))return n;if(s||null!=n||ii(r,Tt())){const r=function(e){return(e.visible||s)&&(!i||!~i.indexOf(e.writeId))&&(Lt(e.path,t)||Lt(t,e.path))};return hi(_i(e.allWrites,r,t),n||_n.EMPTY_NODE)}return null}{const i=si(e.visibleWrites,t);if(null!=i)return i;{const i=oi(e.visibleWrites,t);if(ai(i))return n;if(null!=n||ii(i,Tt())){return hi(i,n||_n.EMPTY_NODE)}return null}}}function gi(e,t,n,i){return fi(e.writeTree,e.treePath,t,n,i)}function mi(e,t){return function(e,t,n){let i=_n.EMPTY_NODE;const s=si(e.visibleWrites,t);if(s)return s.isLeafNode()||s.forEachChild(on,((e,t)=>{i=i.updateImmediateChild(e,t)})),i;if(n){const s=oi(e.visibleWrites,t);return n.forEachChild(on,((e,t)=>{const n=hi(oi(s,new Et(e)),t);i=i.updateImmediateChild(e,n)})),ri(s).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}return ri(oi(e.visibleWrites,t)).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}(e.writeTree,e.treePath,t)}function yi(e,t,n,s){return function(e,t,n,s,r){i(s||r,"Either existingEventSnap or existingServerSnap must exist");const o=Dt(t,n);if(ii(e.visibleWrites,o))return null;{const t=oi(e.visibleWrites,o);return ai(t)?r.getChild(n):hi(t,r.getChild(n))}}(e.writeTree,e.treePath,t,n,s)}function vi(e,t){return function(e,t){return si(e.visibleWrites,t)}(e.writeTree,Dt(e.treePath,t))}function Ci(e,t,n,i,s,r){return function(e,t,n,i,s,r,o){let a;const h=oi(e.visibleWrites,t),l=si(h,Tt());if(null!=l)a=l;else{if(null==n)return[];a=hi(h,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let h=n.getNext();for(;h&&e.length<s;)0!==t(h,i)&&e.push(h),h=n.getNext();return e}}(e.writeTree,e.treePath,t,n,i,s,r)}function wi(e,t,n){return function(e,t,n,i){const s=Dt(t,n),r=si(e.visibleWrites,s);if(null!=r)return r;if(i.isCompleteForChild(n))return hi(oi(e.visibleWrites,s),i.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function bi(e,t){return Ii(Dt(e.treePath,t),e.writeTree)}function Ii(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ti=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Si{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Bn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return wi(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Qn(this.viewCache_),s=Ci(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ni(e,t,n,r,o){const a=new Ei;let h,l;if(n.type===Fn.OVERWRITE){const s=n;s.source.fromUser?h=xi(e,t,s.path,s.snap,r,o,a):(i(s.source.fromServer,"Unknown source."),l=s.source.tagged||t.serverCache.isFiltered()&&!At(s.path),h=Pi(e,t,s.path,s.snap,r,o,l,a))}else if(n.type===Fn.MERGE){const s=n;s.source.fromUser?h=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,h)=>{const l=Dt(n,i);Ri(t,St(l))&&(a=xi(e,a,l,h,s,r,o))})),i.foreach(((i,h)=>{const l=Dt(n,i);Ri(t,St(l))||(a=xi(e,a,l,h,s,r,o))})),a}(e,t,s.path,s.children,r,o,a):(i(s.source.fromServer,"Unknown source."),l=s.source.tagged||t.serverCache.isFiltered(),h=Ai(e,t,s.path,s.children,r,o,l,a))}else if(n.type===Fn.ACK_USER_WRITE){const s=n;h=s.revert?function(e,t,n,s,r,o){let a;if(null!=vi(s,n))return t;{const h=new Si(s,t,r),l=t.eventCache.getNode();let c;if(At(n)||".priority"===St(n)){let n;if(t.serverCache.isFullyInitialized())n=gi(s,Qn(t));else{const e=t.serverCache.getNode();i(e instanceof _n,"serverChildren would be complete if leaf node"),n=mi(s,e)}c=e.filter.updateFullNode(l,n,o)}else{const i=St(n);let r=wi(s,i,t.serverCache);null==r&&t.serverCache.isCompleteForChild(i)&&(r=l.getImmediateChild(i)),c=null!=r?e.filter.updateChild(l,i,r,kt(n),h,o):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(l,i,_n.EMPTY_NODE,kt(n),h,o):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=gi(s,Qn(t)),a.isLeafNode()&&(c=e.filter.updateFullNode(c,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=vi(s,Tt()),Yn(t,c,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,s.path,r,o,a):function(e,t,n,i,s,r,o){if(null!=vi(s,n))return t;const a=t.serverCache.isFiltered(),h=t.serverCache;if(null!=i.value){if(At(n)&&h.isFullyInitialized()||h.isCompleteForPath(n))return Pi(e,t,n,h.getNode().getChild(n),s,r,a,o);if(At(n)){let i=new Jn(null);return h.getNode().forEachChild($t,((e,t)=>{i=i.set(new Et(e),t)})),Ai(e,t,n,i,s,r,a,o)}return t}{let l=new Jn(null);return i.foreach(((e,t)=>{const i=Dt(n,e);h.isCompleteForPath(i)&&(l=l.set(e,h.getNode().getChild(i)))})),Ai(e,t,n,l,s,r,a,o)}}(e,t,s.path,s.affectedTree,r,o,a)}else{if(n.type!==Fn.LISTEN_COMPLETE)throw s("Unknown operation type: "+n.type);h=function(e,t,n,i,s){const r=t.serverCache,o=Gn(t,r.getNode(),r.isFullyInitialized()||At(n),r.isFiltered());return ki(e,o,n,i,Ti,s)}(e,t,n.path,r,a)}const c=a.getChanges();return function(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Kn(e);(n.length>0||!e.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Cn(Kn(t)))}}(t,h,c),{viewCache:h,changes:c}}function ki(e,t,n,s,r,o){const a=t.eventCache;if(null!=vi(s,n))return t;{let h,l;if(At(n))if(i(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Qn(t),i=mi(s,n instanceof _n?n:_n.EMPTY_NODE);h=e.filter.updateFullNode(t.eventCache.getNode(),i,o)}else{const n=gi(s,Qn(t));h=e.filter.updateFullNode(t.eventCache.getNode(),n,o)}else{const c=St(n);if(".priority"===c){i(1===Nt(n),"Can't have a priority with additional path components");const r=a.getNode();l=t.serverCache.getNode();const o=yi(s,n,r,l);h=null!=o?e.filter.updatePriority(r,o):a.getNode()}else{const i=kt(n);let u;if(a.isCompleteForChild(c)){l=t.serverCache.getNode();const e=yi(s,n,a.getNode(),l);u=null!=e?a.getNode().getImmediateChild(c).updateChild(i,e):a.getNode().getImmediateChild(c)}else u=wi(s,c,t.serverCache);h=null!=u?e.filter.updateChild(a.getNode(),c,u,i,r,o):a.getNode()}}return Yn(t,h,a.isFullyInitialized()||At(n),e.filter.filtersNodes())}}function Pi(e,t,n,i,s,r,o,a){const h=t.serverCache;let l;const c=o?e.filter:e.filter.getIndexedFilter();if(At(n))l=c.updateFullNode(h.getNode(),i,null);else if(c.filtersNodes()&&!h.isFiltered()){const e=h.getNode().updateChild(n,i);l=c.updateFullNode(h.getNode(),e,null)}else{const e=St(n);if(!h.isCompleteForPath(n)&&Nt(n)>1)return t;const s=kt(n),r=h.getNode().getImmediateChild(e).updateChild(s,i);l=".priority"===e?c.updatePriority(h.getNode(),r):c.updateChild(h.getNode(),e,r,s,Ti,null)}const u=Gn(t,l,h.isFullyInitialized()||At(n),c.filtersNodes());return ki(e,u,n,s,new Si(s,u,r),a)}function xi(e,t,n,i,s,r,o){const a=t.eventCache;let h,l;const c=new Si(s,t,r);if(At(n))l=e.filter.updateFullNode(t.eventCache.getNode(),i,o),h=Yn(t,l,!0,e.filter.filtersNodes());else{const s=St(n);if(".priority"===s)l=e.filter.updatePriority(t.eventCache.getNode(),i),h=Yn(t,l,a.isFullyInitialized(),a.isFiltered());else{const r=kt(n),l=a.getNode().getImmediateChild(s);let u;if(At(r))u=i;else{const e=c.getCompleteChild(s);u=null!=e?".priority"===Pt(r)&&e.getChild(Rt(r)).isEmpty()?e:e.updateChild(r,i):_n.EMPTY_NODE}if(l.equals(u))h=t;else{h=Yn(t,e.filter.updateChild(a.getNode(),s,u,r,c,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return h}function Ri(e,t){return e.eventCache.isCompleteForChild(t)}function Di(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Ai(e,t,n,i,s,r,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let h,l=t;h=At(n)?i:new Jn(null).setTree(n,i);const c=t.serverCache.getNode();return h.children.inorderTraversal(((n,i)=>{if(c.hasChild(n)){const h=Di(0,t.serverCache.getNode().getImmediateChild(n),i);l=Pi(e,l,new Et(n),h,s,r,o,a)}})),h.children.inorderTraversal(((n,i)=>{const h=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!c.hasChild(n)&&!h){const h=Di(0,t.serverCache.getNode().getImmediateChild(n),i);l=Pi(e,l,new Et(n),h,s,r,o,a)}})),l}class Mi{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,i=new En(n.getIndex()),s=(r=n).loadsAllData()?new En(r.getIndex()):r.hasLimit()?new Sn(r):new Tn(r);var r;this.processor_=function(e){return{filter:e}}(s);const o=t.serverCache,a=t.eventCache,h=i.updateFullNode(_n.EMPTY_NODE,o.getNode(),null),l=s.updateFullNode(_n.EMPTY_NODE,a.getNode(),null),c=new Bn(h,o.isFullyInitialized(),i.filtersNodes()),u=new Bn(l,a.isFullyInitialized(),s.filtersNodes());this.viewCache_=$n(u,c),this.eventGenerator_=new zn(this.query_)}get query(){return this.query_}}function Oi(e,t){const n=Qn(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!At(t)&&!n.getImmediateChild(St(t)).isEmpty())?n.getChild(t):null}function Li(e,t,n,s){t.type===Fn.MERGE&&null!==t.source.queryId&&(i(Qn(e.viewCache_),"We should always have a full cache before handling merges"),i(Kn(e.viewCache_),"Missing event cache, even though we have a server cache"));const r=e.viewCache_,o=Ni(e.processor_,r,t,n,s);var a,h;return a=e.processor_,h=o.viewCache,i(h.eventCache.getNode().isIndexed(a.filter.getIndex()),"Event snap not indexed"),i(h.serverCache.getNode().isIndexed(a.filter.getIndex()),"Server snap not indexed"),i(o.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=o.viewCache,Fi(e,o.changes,o.viewCache.eventCache.getNode(),null)}function Fi(e,t,n,i){const s=i?[i]:e.eventRegistrations_;return function(e,t,n,i){const s=[],r=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&r.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Vn(e,s,"child_removed",t,i,n),Vn(e,s,"child_added",t,i,n),Vn(e,s,"child_moved",r,i,n),Vn(e,s,"child_changed",t,i,n),Vn(e,s,"value",t,i,n),s}(e.eventGenerator_,t,n,s)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qi,Wi;class Ui{constructor(){this.views=new Map}}function Hi(e,t,n,s){const r=t.source.queryId;if(null!==r){const o=e.views.get(r);return i(null!=o,"SyncTree gave us an op for an invalid query."),Li(o,t,n,s)}{let i=[];for(const r of e.views.values())i=i.concat(Li(r,t,n,s));return i}}function ji(e,t,n,i,s){const r=t._queryIdentifier,o=e.views.get(r);if(!o){let e=gi(n,s?i:null),r=!1;e?r=!0:i instanceof _n?(e=mi(n,i),r=!1):(e=_n.EMPTY_NODE,r=!1);const o=$n(new Bn(e,r,!1),new Bn(i,s,!1));return new Mi(t,o)}return o}function Bi(e,t){let n=null;for(const i of e.views.values())n=n||Oi(i,t);return n}class zi{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Jn(null),this.pendingWriteTree_={visibleWrites:Zn.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Vi(e,t,n,s,r){return function(e,t,n,s,r){i(s>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:s,visible:r}),r&&(e.visibleWrites=ei(e.visibleWrites,t,n)),e.lastWriteId=s}(e.pendingWriteTree_,t,n,s,r),r?Qi(e,new Hn({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function $i(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(ui(e.pendingWriteTree_,t)){let t=new Jn(null);return null!=i.snap?t=t.set(Tt(),!0):Je(i.children,(e=>{t=t.set(new Et(e),!0)})),Qi(e,new Un(i.path,t,n))}return[]}function Yi(e,t,n){return Qi(e,new Hn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Gi(e,t,n){const i=e.pendingWriteTree_,s=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Bi(n,Mt(e,t));if(i)return i}));return fi(i,t,s,n,!0)}function Ki(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const s=Mt(e,n);i=i||Bi(t,s)}));let s=e.syncPointTree_.get(n);s?i=i||Bi(s,Tt()):(s=new Ui,e.syncPointTree_=e.syncPointTree_.set(n,s));const r=null!=i,o=r?new Bn(i,!0,!1):null;return function(e){return Kn(e.viewCache_)}(ji(s,t,ci(e.pendingWriteTree_,t._path),r?o.getNode():_n.EMPTY_NODE,r))}function Qi(e,t){return Xi(t,e.syncPointTree_,null,ci(e.pendingWriteTree_,Tt()))}function Xi(e,t,n,i){if(At(e.path))return Ji(e,t,n,i);{const s=t.get(Tt());null==n&&null!=s&&(n=Bi(s,Tt()));let r=[];const o=St(e.path),a=e.operationForChild(o),h=t.children.get(o);if(h&&a){const e=n?n.getImmediateChild(o):null,t=bi(i,o);r=r.concat(Xi(a,h,e,t))}return s&&(r=r.concat(Hi(s,e,i,n))),r}}function Ji(e,t,n,i){const s=t.get(Tt());null==n&&null!=s&&(n=Bi(s,Tt()));let r=[];return t.children.inorderTraversal(((t,s)=>{const o=n?n.getImmediateChild(t):null,a=bi(i,t),h=e.operationForChild(t);h&&(r=r.concat(Ji(h,s,o,a)))})),s&&(r=r.concat(Hi(s,e,i,n))),r}function Zi(e,t){return e.tagToQueryMap.get(t)}function es(e){const t=e.indexOf("$");return i(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Et(e.substr(0,t))}}function ts(e,t,n){const s=e.syncPointTree_.get(t);i(s,"Missing sync point for query tag that we're tracking");return Hi(s,n,ci(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ns{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ns(t)}node(){return this.node_}}class is{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Dt(this.path_,e);return new is(this.syncTree_,t)}node(){return Gi(this.syncTree_,this.path_)}}const ss=function(e,t,n){return e&&"object"==typeof e?(i(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?rs(e[".sv"],t,n):"object"==typeof e[".sv"]?os(e[".sv"],t):void i(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},rs=function(e,t,n){if("timestamp"===e)return n.timestamp;i(!1,"Unexpected server value: "+e)},os=function(e,t,n){e.hasOwnProperty("increment")||i(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const s=e.increment;"number"!=typeof s&&i(!1,"Unexpected increment value: "+s);const r=t.node();if(i(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return s;const o=r.getValue();return"number"!=typeof o?s:o+s},as=function(e,t,n,i){return ls(t,new is(n,e),i)},hs=function(e,t,n){return ls(e,new ns(t),n)};function ls(e,t,n){const i=e.getPriority().val(),s=ss(i,t.getImmediateChild(".priority"),n);let r;if(e.isLeafNode()){const i=e,r=ss(i.getValue(),t,n);return r!==i.getValue()||s!==i.getPriority().val()?new rn(r,gn(s)):e}{const i=e;return r=i,s!==i.getPriority().val()&&(r=r.updatePriority(new rn(s))),i.forEachChild(on,((e,i)=>{const s=ls(i,t.getImmediateChild(e),n);s!==i&&(r=r.updateImmediateChild(e,s))})),r}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function us(e,t){let n=t instanceof Et?t:new Et(t),i=e,s=St(n);for(;null!==s;){const e=I(i.node.children,s)||{children:{},childCount:0};i=new cs(s,i,e),n=kt(n),s=St(n)}return i}function ds(e){return e.node.value}function ps(e,t){e.node.value=t,ys(e)}function _s(e){return e.node.childCount>0}function fs(e,t){Je(e.node.children,((n,i)=>{t(new cs(n,e,i))}))}function gs(e,t,n,i){n&&!i&&t(e),fs(e,(e=>{gs(e,t,!0,i)})),n&&i&&t(e)}function ms(e){return new Et(null===e.parent?e.name:ms(e.parent)+"/"+e.name)}function ys(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===ds(e)&&!_s(e)}(n),s=b(e.node.children,t);i&&s?(delete e.node.children[t],e.node.childCount--,ys(e)):i||s||(e.node.children[t]=n.node,e.node.childCount++,ys(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const vs=/[\[\].#$\/\u0000-\u001F\u007F]/,Cs=/[\[\].#$\u0000-\u001F\u007F]/,ws=function(e){return"string"==typeof e&&0!==e.length&&!vs.test(e)},bs=function(e){return"string"==typeof e&&0!==e.length&&!Cs.test(e)},Is=function(e,t,n){const i=n instanceof Et?new Ft(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Wt(i));if("function"==typeof t)throw new Error(e+"contains a function "+Wt(i)+" with contents = "+t.toString());if($e(t))throw new Error(e+"contains "+t.toString()+" "+Wt(i));if("string"==typeof t&&t.length>10485760/3&&x(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Wt(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,s=!1;if(Je(t,((t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!ws(t)))throw new Error(e+" contains an invalid key ("+t+") "+Wt(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');!function(e,t){e.parts_.length>0&&(e.byteLength_+=1),e.parts_.push(t),e.byteLength_+=x(t),qt(e)}(i,t),Is(e,r,i),function(e){const t=e.parts_.pop();e.byteLength_-=x(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&s)throw new Error(e+' contains ".value" child '+Wt(i)+" in addition to actual children.")}},Es=function(e,t,n,i){if(!(i&&void 0===n||bs(n)))throw new Error(P(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ts=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!ws(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),bs(e)}(n))throw new Error(P(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ss{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ns(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ot(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function ks(e,t,n){Ns(e,n),xs(e,(e=>Ot(e,t)))}function Ps(e,t,n){Ns(e,n),xs(e,(e=>Lt(e,t)||Lt(t,e)))}function xs(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Rs(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Rs(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qe&&He("event: "+n.toString()),nt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ds{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ss,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Dn(),this.transactionQueueTree_=new cs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function As(e,t,n){if(e.stats_=pt(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new xn(e.repoInfo_,((t,n,i,s)=>{Ls(e,t,n,i,s)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Fs(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{C(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Ht(e.repoInfo_,t,((t,n,i,s)=>{Ls(e,t,n,i,s)}),(t=>{Fs(e,t)}),(t=>{!function(e,t){Je(t,((t,n)=>{qs(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return dt[n]||(dt[n]=t()),dt[n]}(e.repoInfo_,(()=>new Ln(e.stats_,e.server_))),e.infoData_=new Rn,e.infoSyncTree_=new zi({startListening:(t,n,i,s)=>{let r=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(r=Yi(e.infoSyncTree_,t._path,o),setTimeout((()=>{s("ok")}),0)),r},stopListening:()=>{}}),qs(e,"connected",!1),e.serverSyncTree_=new zi({startListening:(t,n,i,s)=>(e.server_.listen(t,i,n,((n,i)=>{const r=s(n,i);Ps(e.eventQueue_,t._path,r)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Ms(e){const t=e.infoData_.getNode(new Et(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Os(e){return(t=(t={timestamp:Ms(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Ls(e,t,n,i,s){e.dataUpdateCount++;const r=new Et(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(s)if(i){const t=T(n,(e=>gn(e)));o=function(e,t,n,i){const s=Zi(e,i);if(s){const i=es(s),r=i.path,o=i.queryId,a=Mt(r,t),h=Jn.fromObject(n);return ts(e,r,new jn(Wn(o),a,h))}return[]}(e.serverSyncTree_,r,t,s)}else{const t=gn(n);o=function(e,t,n,i){const s=Zi(e,i);if(null!=s){const i=es(s),r=i.path,o=i.queryId,a=Mt(r,t);return ts(e,r,new Hn(Wn(o),a,n))}return[]}(e.serverSyncTree_,r,t,s)}else if(i){const t=T(n,(e=>gn(e)));o=function(e,t,n){const i=Jn.fromObject(n);return Qi(e,new jn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,r,t)}else{const t=gn(n);o=Yi(e.serverSyncTree_,r,t)}let a=r;o.length>0&&(a=zs(e,r)),Ps(e.eventQueue_,a,o)}function Fs(e,t){qs(e,"connected",t),!1===t&&function(e){Hs(e,"onDisconnectEvents");const t=Os(e),n=Dn();Mn(e.onDisconnect_,Tt(),((i,s)=>{const r=as(i,s,e.serverSyncTree_,t);An(n,i,r)}));let i=[];Mn(n,Tt(),((t,n)=>{i=i.concat(Yi(e.serverSyncTree_,t,n));const s=Ks(e,t);zs(e,s)})),e.onDisconnect_=Dn(),Ps(e.eventQueue_,Tt(),i)}(e)}function qs(e,t,n){const i=new Et("/.info/"+t),s=gn(n);e.infoData_.updateSnapshot(i,s);const r=Yi(e.infoSyncTree_,i,s);Ps(e.eventQueue_,i,r)}function Ws(e){return e.nextWriteId_++}function Us(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Hs(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),He(n,...t)}function js(e,t,n){return Gi(e.serverSyncTree_,t,n)||_n.EMPTY_NODE}function Bs(e,t=e.transactionQueueTree_){if(t||Gs(e,t),ds(t)){const n=$s(e,t);i(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const s=n.map((e=>e.currentWriteId)),r=js(e,t,s);let o=r;const a=r.hash();for(let e=0;e<n.length;e++){const s=n[e];i(0===s.status,"tryToSendTransactionQueue_: items in queue should all be run."),s.status=1,s.retryCount++;const r=Mt(t,s.path);o=o.updateChild(r,s.currentOutputSnapshotRaw)}const h=o.val(!0),l=t;e.server_.put(l.toString(),h,(i=>{Hs(e,"transaction put response",{path:l.toString(),status:i});let s=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,s=s.concat($i(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Gs(e,us(e.transactionQueueTree_,t)),Bs(e,e.transactionQueueTree_),Ps(e.eventQueue_,t,s);for(let e=0;e<i.length;e++)nt(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Ve("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}zs(e,t)}}),a)}(e,ms(t),n)}else _s(t)&&fs(t,(t=>{Bs(e,t)}))}function zs(e,t){const n=Vs(e,t),s=ms(n);return function(e,t,n){if(0===t.length)return;const s=[];let r=[];const o=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let h=0;h<t.length;h++){const l=t[h],c=Mt(n,l.path);let u,d=!1;if(i(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)d=!0,u=l.abortReason,r=r.concat($i(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)d=!0,u="maxretry",r=r.concat($i(e.serverSyncTree_,l.currentWriteId,!0));else{const n=js(e,l.path,o);l.currentInputSnapshot=n;const i=t[h].update(n.val());if(void 0!==i){Is("transaction failed: Data returned ",i,l.path);let t=gn(i);"object"==typeof i&&null!=i&&b(i,".priority")||(t=t.updatePriority(n.getPriority()));const s=l.currentWriteId,a=Os(e),h=hs(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=h,l.currentWriteId=Ws(e),o.splice(o.indexOf(s),1),r=r.concat(Vi(e.serverSyncTree_,l.path,h,l.currentWriteId,l.applyLocally)),r=r.concat($i(e.serverSyncTree_,s,!0))}else d=!0,u="nodata",r=r.concat($i(e.serverSyncTree_,l.currentWriteId,!0))}Ps(e.eventQueue_,n,r),r=[],d&&(t[h].status=2,a=t[h].unwatcher,setTimeout(a,Math.floor(0)),t[h].onComplete&&("nodata"===u?s.push((()=>t[h].onComplete(null,!1,t[h].currentInputSnapshot))):s.push((()=>t[h].onComplete(new Error(u),!1,null)))))}var a;Gs(e,e.transactionQueueTree_);for(let e=0;e<s.length;e++)nt(s[e]);Bs(e,e.transactionQueueTree_)}(e,$s(e,n),s),s}function Vs(e,t){let n,i=e.transactionQueueTree_;for(n=St(t);null!==n&&void 0===ds(i);)i=us(i,n),n=St(t=kt(t));return i}function $s(e,t){const n=[];return Ys(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function Ys(e,t,n){const i=ds(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);fs(t,(t=>{Ys(e,t,n)}))}function Gs(e,t){const n=ds(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,ps(t,n.length>0?n:void 0)}fs(t,(t=>{Gs(e,t)}))}function Ks(e,t){const n=ms(Vs(e,t)),i=us(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{Qs(e,t)})),Qs(e,i),gs(i,(t=>{Qs(e,t)})),n}function Qs(e,t){const n=ds(t);if(n){const s=[];let r=[],o=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(i(o===t-1,"All SENT items should be at beginning of queue."),o=t,n[t].status=3,n[t].abortReason="set"):(i(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat($i(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&s.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===o?ps(t,void 0):n.length=o+1,Ps(e.eventQueue_,ms(t),r);for(let e=0;e<s.length;e++)nt(s[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zs{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return At(this._path)?null:Pt(this._path)}get ref(){return new er(this._repo,this._path)}get _queryIdentifier(){const e=Pn(this._queryParams),t=Qe(e);return"{}"===t?"default":t}get _queryObject(){return Pn(this._queryParams)}isEqual(e){if(!((e=R(e))instanceof Zs))return!1;const t=this._repo===e._repo,n=Ot(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class er extends Zs{constructor(e,t){super(e,t,new Nn,!1)}get parent(){const e=Rt(this._path);return null===e?null:new er(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class tr{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Et(e),n=ir(this.ref,e);return new tr(this._node.getChild(t),n,on)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new tr(n,ir(this.ref,t),on))))}hasChild(e){const t=new Et(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function nr(e,t){return(e=R(e))._checkNotDeleted("ref"),void 0!==t?ir(e._root,t):e._root}function ir(e,t){var n,i,s,r;return null===St((e=R(e))._path)?(n="child",i="path",r=!1,(s=t)&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),Es(n,i,s,r)):Es("child","path",t,!1),new er(e._repo,Dt(e._path,t))}function sr(e){return function(e,t){const n=Ki(e.serverSyncTree_,t);return null!=n?Promise.resolve(n):e.server_.get(t).then((n=>{const i=gn(n).withIndex(t._queryParams.getIndex()),s=Yi(e.serverSyncTree_,t._path,i);return ks(e.eventQueue_,t._path,s),Promise.resolve(i)}),(n=>(Hs(e,"get for query "+C(t)+" failed: "+n),Promise.reject(new Error(n)))))}((e=R(e))._repo,e).then((t=>new tr(t,new er(e._repo,e._path),e._queryParams.getIndex())))}!function(e){i(!qi,"__referenceConstructor has already been defined"),qi=e}(er),function(e){i(!Wi,"__referenceConstructor has already been defined"),Wi=e}(er);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const rr={};let or=!1;function ar(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,h=Xs(r,s),l=h.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${l.namespace}`,h=Xs(r,s),l=h.repoInfo):o=!h.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Ts("Invalid Firebase Database URL",h),At(h.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=rr[t.name];s||(s={},rr[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new Ds(e,or,n,i),s[e.toURLString()]=r,r}(l,e,c,new st(e.name,n));return new hr(u,e)}class hr{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(As(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new er(this._repo,Tt())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=rr[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Us(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}Ht.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ht.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){ke="9.6.10",Z(new F("database",((e,{instanceIdentifier:t})=>ar(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ie("@firebase/database","0.12.7",e),ie("@firebase/database","0.12.7","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");const lr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyA-xuqJuBjNQpnieD41HNIK5u0qjyslN60",authDomain:"brorzdb.firebaseapp.com",databaseURL:"https://brorzdb-default-rtdb.europe-west1.firebasedatabase.app",projectId:"brorzdb",storageBucket:"brorzdb.appspot.com",messagingSenderId:"153296976078",appId:"1:153296976078:web:a45ca237c15fa06971b89f"})),cr=document.querySelector("#user-name-login"),ur=document.querySelector("#user-password-login");document.getElementById("login-btn").addEventListener("click",(e=>{e.preventDefault();sr(ir(nr(lr),"/Users/")).then((e=>{for(let t in e.val())e.val()[t].userName==cr.value&&e.val()[t].password==ur.value&&console.log("yay")}))}));
//# sourceMappingURL=index.d4d7b8f7.js.map
